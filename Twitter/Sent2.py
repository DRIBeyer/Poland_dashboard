...
if ('National Politicians' in df['title'].values) and ('Regional Politicians' in df['title'].values):

    # Filter rows based on the title column
    df = df[df['title'].isin(['National Politicians', 'Regional Politicians'])]


else:
    print("Both titles are not present in the DataFrame.")
