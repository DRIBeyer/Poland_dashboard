...
def get_tweets_by_screen_names(screen_names, start_date=None, end_date=None):
    # If start_date is not provided, set it to one week before the current date
    if not start_date:
...
def collect(excel_file):
    ...
    for sheet in target_sheets:
        ...
        if 'Twitter user' in df.columns:
            ...
            data = get_tweets_by_screen_names(filtered_list, start_date=datetime.utcnow() - timedelta(days=16), end_date=datetime.utcnow() - timedelta(days=7))
